...
message(TRACE "ccg::CompilerWarnings")
...
elseif(CCG_COMPILER_GCC)
    target_compile_options(
        ...
        INTERFACE
            ...
            -Wformat=2                  # warn on security issues around functions that format output (i.e. printf)
            -Wimplicit-fallthrough      # warn on statements that fall-through without an explicit annotation
            -Wmisleading-indentation    # warn on indentation implies blocks where blocks do not exist
            -Wduplicated-cond           # warn on if / else chain has duplicated conditions
            -Wduplicated-branches       # warn on if / else branches have duplicated code
...
elseif(CCG_COMPILER_MSVC)
    target_compile_options(
        ...
        INTERFACE
            ...
            /w14826         # Conversion from 'type1' to 'type2' is sign-extended. This may cause unexpected runtime
                            # behavior
    ...
    message(SEND_ERROR "CompilerWarnings not supported for ${CMAKE_CXX_COMPILER_ID}")
endif()


if (CCG_ENABLE_WARNINGS_AS_ERRORS)
    message(TRACE "Warnings are treated as errors")
    target_compile_options(
        ccg_base_target
        INTERFACE
            $<$<BOOL:${CCG_COMPILER_CLANG}>:-Werror>
            $<$<BOOL:${CCG_COMPILER_CLANGCL}>:-Werror>
            $<$<BOOL:${CCG_COMPILER_GCC}>:-Werror>
            $<$<BOOL:${CCG_COMPILER_MSVC}>:/WX>
    )
endif()